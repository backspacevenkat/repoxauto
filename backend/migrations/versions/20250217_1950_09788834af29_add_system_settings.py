...
def upgrade() -> None:
    ...
    op.drop_table('follow_progress')
    op.drop_index('ix_follow_lists_username', table_name='follow_lists')
    op.drop_table('follow_lists')
    op.drop_index('ix_follow_settings_id', table_name='follow_settings')
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('follow_progress',
